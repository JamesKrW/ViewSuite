"""
GraphRL Environment base classes.

Re-exports VAGEN's gym environment base classes for convenience.
Environment authors should subclass these for their RL environments
and provide separate graph_builder / SFT generator as registered classes.

Usage::

    from graphrl.envs.gym_image_env import GymImageEnv
...
#Refer to VAEGN's GymImageEnv for the base environment class that supports image-based multi-modal observations.
